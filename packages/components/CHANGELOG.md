...
- **checkbox:** default value to 'on' for native form submission ([#2392](https://github.com/telekom/scale/issues/2392)) ([#2516](https://github.com/telekom/scale/issues/2516)) ([7347923](https://github.com/telekom/scale/commit/734792348e848d0a421789560959e10e7fa4a446))
- **components:** improve dark-mode error message contrast ([#2489](https://github.com/telekom/scale/issues/2489)) ([5b7d83c](https://github.com/telekom/scale/commit/5b7d83cdcd968268701260ae857787b69d80ff74)), closes [#2093](https://github.com/telekom/scale/issues/2093) [#2093](https://github.com/telekom/scale/issues/2093)
- **data-grid/text-cell:** pass accessibilityTitle to prefix and suffix icons ([#2487](https://github.com/telekom/scale/issues/2487)) ([5f228bc](https://github.com/telekom/scale/commit/5f228bc185150d500427f44df08221a3e4bab8d6))
- **dropdown-select:** propagate aria-details-id to combobox element ([#2443](https://github.com/telekom/scale/issues/2443)) ([#2517](https://github.com/telekom/scale/issues/2517)) ([42399c2](https://github.com/telekom/scale/commit/42399c28cfc5f16997dbc37177405a1189ba976e))
- **react-wrapper:** missing non event props where missing in ts declaration ([#2488](https://github.com/telekom/scale/issues/2488)) ([68fdde9](https://github.com/telekom/scale/commit/68fdde97481fc1c59d0d1a8256f870568b4f7492))
- **tag:** keyboard/a11y for tag arrow navigation ([#2419](https://github.com/telekom/scale/issues/2419)) ([#2490](https://github.com/telekom/scale/issues/2490)) ([ad04d0a](https://github.com/telekom/scale/commit/ad04d0a09d023dfc5ff7ce7e855b1643df7b4bf1))
- **telekom-mobile-flyout-canvas:** link app name ([#2518](https://github.com/telekom/scale/issues/2518)) ([09cbef8](https://github.com/telekom/scale/commit/09cbef89a95c08f5301384be0338c1248de4152f)), closes [#2378](https://github.com/telekom/scale/issues/2378) [#2378](https://github.com/telekom/scale/issues/2378)
- **telekom-nav-flyout:** open anchor flyouts with keyboard ([#2519](https://github.com/telekom/scale/issues/2519)) ([14f8a3f](https://github.com/telekom/scale/commit/14f8a3f1b5f387bd9c93751f96985de7d00b34e8)), closes [#2416](https://github.com/telekom/scale/issues/2416) [#2416](https://github.com/telekom/scale/issues/2416)

### Features

- use tokens for menu flyout list padding ([#2496](https://github.com/telekom/scale/issues/2496)) ([2327cfe](https://github.com/telekom/scale/commit/2327cfe0d61585fcfb88b766c1b42c8eff612e08)), closes [#2507](https://github.com/telekom/scale/issues/2507)
...
- **data-grid:** fix issue with table header overlapping the table body ([#2426](https://github.com/telekom/scale/issues/2426)) ([81dc80c](https://github.com/telekom/scale/commit/81dc80c965cf10ac1674f3eb5d59168bcfbfdb4e))
- **data-grid:** fix overflowing table header text when title space reduced ([#2425](https://github.com/telekom/scale/issues/2425)) ([3279e36](https://github.com/telekom/scale/commit/3279e36144a79e7453684b8880575fc1b364153a))
- **helper-text:** add aria-hidden to helper icons ([#2402](https://github.com/telekom/scale/issues/2402)) ([f71532d](https://github.com/telekom/scale/commit/f71532dc127bac802aed8e06b7e4420e41a79a82))

# [3.0.0-beta.156](https://github.com/telekom/scale/compare/v3.0.0-beta.154...v3.0.0-beta.156) (2025-06-19)

### Bug Fixes

- **data-grid:** prevents null or undefined break max content length calculation ([#2395](https://github.com/telekom/scale/issues/2395)) ([32afca9](https://github.com/telekom/scale/commit/32afca9044067a53c71a4d28d82086319b2d5b5b))
- **date-picker:** check for querySelector value added ([#2374](https://github.com/telekom/scale/issues/2374)) ([dac9e93](https://github.com/telekom/scale/commit/dac9e93f2f30ef18d84d586a74b200476646148a))
...
- **mega-menu-column:** fixed its positioning when screen is small ([#2388](https://github.com/telekom/scale/issues/2388)) ([cb4f115](https://github.com/telekom/scale/commit/cb4f115b63f49a4986cace687f81043f4bfd22d8))
...
- **segmented button:** Scale Segmented Button doesn't respect controlled selected state ([#2166](https://github.com/telekom/scale/issues/2166)) ([#2384](https://github.com/telekom/scale/issues/2384)) ([39ad8ab](https://github.com/telekom/scale/commit/39ad8ab04f457ebe84b122ca3bd17802e9a4cacf))
- **segmented-button:** fixed ratio contrast to fulfill AA requirement ([#2385](https://github.com/telekom/scale/issues/2385)) ([de88dfc](https://github.com/telekom/scale/commit/de88dfcf7a91349e3d8acfb8d4aa2fbd92cd62e5))
- **switch:** add text color for switch toggle ([#2396](https://github.com/telekom/scale/issues/2396)) ([39accf4](https://github.com/telekom/scale/commit/39accf4ef6004b6624ade3477d6cc0f00d5d13e1))
- **telekom-mobile-menu-item:** fixed icon placing ([#2387](https://github.com/telekom/scale/issues/2387)) ([0307f25](https://github.com/telekom/scale/commit/0307f25d8f7bffe68adcd859fa3e9aab46a4615e))

### Features

- **dropdown-select:** add clear button to improve user experience ([#2391](https://github.com/telekom/scale/issues/2391)) ([9fbe1c6](https://github.com/telekom/scale/commit/9fbe1c64ca0ae7360645d7f9263897fcae206c97))
