...
| `inputprefix`    | `inputprefix`     | (optional) input prefix                                                                                         | `string`                                                                              | `undefined` |
| `inputsuffix`    | `inputsuffix`     | (optional) input suffix                                                                                         | `string`                                                                              | `undefined` |
...
| `prefixiconname` | `prefixiconname`  | (optional) input icon                                                                                           | `string`                                                                              | `undefined` |
| `readonly`       | `readonly`        | (optional) Input readonly                                                                                       | `boolean`                                                                             | `undefined` |
| `required`       | `required`        | (optional) Input required                                                                                       | `boolean`                                                                             | `undefined` |
| `reset`          | `reset`           | (optional) show reset button                                                                                    | `boolean`                                                                             | `undefined` |
| `revealpassword` | `revealpassword`  | (optional) show reveal password button                                                                          | `boolean`                                                                             | `undefined` |
...
- [scale-icon-action-show-password](../icons/action-show-password)
...
```mermaid
graph TD;
  scale-text-field-v2 --> scale-icon-action-show-password
  scale-text-field-v2 --> scale-icon-action-hide-password
  scale-text-field-v2 --> scale-icon-action-circle-close
  style scale-text-field-v2 fill:#f9f,stroke:#333,stroke-width:4px
```
