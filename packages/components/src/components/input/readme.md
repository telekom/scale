...
| `--input-border-radius` | Border radius of the input |
| `--input-font-family`   | Font family of the input   |
| `--input-font-size`     | Font size of the input     |
| `--input-padding`       | Padding of the input       |
