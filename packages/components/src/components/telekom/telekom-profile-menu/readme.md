...
graph TD;
  ...
  scale-telekom-profile-menu --> scale-icon-user-file-user
  scale-telekom-profile-menu --> scale-badge
  scale-telekom-profile-menu --> scale-icon-action-checkmark
  ...
  style scale-telekom-profile-menu fill:#f9f,stroke:#333,stroke-width:4px
```
