...
| Name                                             | Description                                  |
| ------------------------------------------------ | -------------------------------------------- |
| `--rating__container-display`                    | Display of the rating container              |
| `--rating__item--emoji-after-content`            | Content of the rating emoji after            |
| `--rating__item--emoji-selected-1-after-content` | Content of the rating star selected 1 after  |
| `--rating__item--emoji-selected-2-after-content` | Content of the rating star selected 2 after  |
