...
| `selectedIds`          | --                       | (controlled) Array of selected segment IDs (for multiSelect)   | `string[]`                       | `undefined`                              |
| `selectedIndex`        | `selected-index`         | (controlled) Index of the selected segment (for single select) | `number`                         | `undefined`                              |
