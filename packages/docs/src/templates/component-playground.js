      ...
      <div className="playground__preview">
        <div>
          {ComponentName.startsWith("scale-") && (
            <ComponentName ref={ref} {...componentProps}>
              {componentState.children || "Label"}
            </ComponentName>
          )}
        </div>
      </div>
      <div className="playground__controls">
        <div key={"children"}>
          ...
          <input
            ...
            value={componentState.children}
            name="children"
            onChange={(e) =>
              setComponentState({ ...componentState, children: e.target.value })
            }
          />
        </div>
        {componentDocs &&
