...
You can find code examples where the Flyout Menu Beta component is implemented in the <a href="?path=/story/components-flyout-menu--brand-header-primary-navigation">Primary navigation</a> and the <a href="?path=/story/components-flyout-menu--brand-header-user-menu">User menu</a>.
