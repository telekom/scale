...
<div class="Notification">
  ...
  <span>There is a newer version of the Brand Header available: <a href="?path=/docs/components-telekom-brand-header-navigation--standard-header">Telekom Brand Header & Navigation</a></span>
</div>
