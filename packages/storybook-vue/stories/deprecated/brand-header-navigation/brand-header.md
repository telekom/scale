...
<div class="Notification">
  ...
  <span>The Brand Header is available in a new version: <a href="?path=/docs/components-telekom-brand-header-navigation--standard-header">Telekom Brand Header & Navigation</a></span>
</div>
