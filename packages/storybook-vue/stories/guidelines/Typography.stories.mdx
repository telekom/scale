  ...
  parameters={{
    docs: {
      container: ({ context }) => {
        ...
        function generateFontFormatTableRow(itemPathString) {
          item = getItemByPathString(itemPathString);
          return (
            <tr>
              <td
              ...
              >
                {getFontWeightNameByNumber(item.value.fontWeight)}
              </td>
              <td
                style={{
                  paddingLeft: 'var(--telekom-spacing-unit-x2)',
              ...
              <div>
                ...
                <div style={{ padding: '0 0 48px 0' }}>
                  ...
                  {lightTokens.tokens
                    .slice(0)
                    .reverse()
                    .filter((item) => item.category == 'Text Style')
                    .map((item) => {
                      {
                        return generateFontFormatTableRow(item.pathString);
                      }
                    })}
                </div>
                <Description
