...
export const iconNavigation = [
    ...
    { name: "Cart", id: "Cart36", href: "#cart", icon: "action-shopping-cart", badge: true, badgeLabel: 3 },
...
<scale-app-shell>
  <scale-app-header slot="header" id="header">
    <div slot="menu-icon">
      ...
      <scale-nav-icon icon="action-play" badge="true" badge-label="1"> Play </scale-nav-icon>
