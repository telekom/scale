...
:host {
  ...
  --background-container: var(--telekom-color-background-surface, #fff);
  ...
  --color-minimal: var(--telekom-color-ui-additional-regular);
  ...
  --background-mask: var(--telekom-color-background-surface, #fff);
  ...
  --color-link-minimal: var(--telekom-color-ui-additional-regular);
