...
```css
scale-text-field {
  --transition: all var(--scl-motion-duration-fast) var(
      --scl-motion-easing-standard
    );
  ...
  /*control*/
  --spacing-control: var(--scl-spacing-12) var(--spacing-x) 0 calc(var(
          --spacing-x
        ) - 1px);
