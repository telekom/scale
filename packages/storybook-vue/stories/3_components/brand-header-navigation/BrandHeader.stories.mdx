      ...
      template: `
        <div class="brand-header-spacing">
          <scale-app-shell>
            ...
            >
                <div slot="logo">
                    <scale-logo transparent variant="white" language="hu" href="#custom" logo-title="Custom" styles=":host { --logo-size: 36px;} @media (max-width: 1023px) { :host {--logo-size: 26px;} }"></scale-logo>
                </div>
            </scale-app-header>
            <div style="height: 800px; padding: 48px 0;">Scroll to test header behavior</div>
            <div style="height: 800px; padding: 48px 0;">Scroll more to test header behavior</div>
...
```html
<scale-app-header claim-lang="de" logo-title="App Name" logo-href="/">
</scale-app-header>
```
