...
```html
<scale-button href="assets/welcome.png" download="welcome.png">Download</scale-button>
```
...
```html
<scale-button size="small" href="assets/welcome.png" download="welcome.png">Download</scale-button>
```
