...
<Canvas withSource="none">
    <Story
        name='Link Download'
        args={{
            href: 'http://localhost:6006/assets/Telekom-Logo-Magenta-350x150.svg',
            download: true,
            label: 'Download'
        }}
    >
...
```html
<scale-button href="http://localhost:6006/assets/Telekom-Logo-Magenta-350x150.svg" download>Download</scale-button>
```
...
```html
<scale-button size="small" href="http://localhost:6006/assets/Telekom-Logo-Magenta-350x150.svg" download>Download</scale-button>
```
