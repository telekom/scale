...
```html
<scale-button href="assets/aa.png" target="_blank" download>Download</scale-button>
```
...
```html
<scale-button size="small" href="assets/aa.png" target="_blank" download>Download</scale-button>
```
