...
:host(scale-menu-flyout-divider) {
  --color: var(--telekom-color-ui-additional-light);
}
```
...
<scale-menu-flyout>
  ...
  <scale-menu-flyout-list>
    <scale-menu-flyout-item>Item 1</scale-menu-flyout-item>
    <scale-menu-flyout-item>Item 2</scale-menu-flyout-item>
    <scale-menu-flyout-item>More Options
...
```html
<scale-menu-flyout-list>
  <scale-menu-flyout-item checked="false">Toggle option 1</scale-menu-flyout-item>
  <scale-menu-flyout-item checked="true">Toggle option 2</scale-menu-flyout-item>
  <scale-menu-flyout-item checked="false">Toggle option 3</scale-menu-flyout-item>
  <scale-menu-flyout-item checked="false">Toggle option 4</scale-menu-flyout-item>
</scale-menu-flyout-list>
```
