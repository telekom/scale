...
```html
<scale-progress-bar percentage="20" style="--background: #009DE0" label="Progress custom"></scale-progress-bar>
```
...
```html
<scale-progress-bar label="Complete custom color" percentage="40" show-status="false" status-description="Upload complete" style="--background: #009DE0">
  <scale-icon-action-success slot="icon" decorative size="16"></scale-icon-action-success>
</scale-progress-bar>
```
