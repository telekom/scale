...
export const Template = (args, { argTypes }) => ({
  ...
  template: `
    <scale-tab-nav :disabled="disabled ? true : false"  :small="small" :size="size" :with-icon="withIcon"></scale-tab-nav>
  `,
});
...
<div style={{
  ...
  Deprication Note: Prop 'small' is depricated and will be replaced by Prop 'size'
</div>
...
<Canvas withSource="none">
  <Story name="Text & Icon, Small" args={{ size: 'small', small: true }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas withSource="none">
  <Story name="Text Only, Small" args={{ size: 'small', small: true, withIcon: false }}>
    {Template.bind({})}
  </Story>
</Canvas>
