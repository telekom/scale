...
## Why AppShell?
App shell is good for accessibility and includes the header and optionally the <a href="?path=/docs/components-footer--standard">Footer</a>. There is a story <a href="?path=/docs/components-brand-header-navigation--standalone-header">demonstrating the standalone mode of the Header</a> for special cases.
