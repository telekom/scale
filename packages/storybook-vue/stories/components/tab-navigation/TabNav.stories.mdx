...
:host {
  --tab-height: 3rem;
  --tab-spacing-horizontal: var(--telekom-spacing-unit-x3);
  --tab-spacing-vertical: var(--telekom-spacing-unit-x4);
  ...
  --tab-spacing-horizontal-large: var(--telekom-spacing-unit-x4);
