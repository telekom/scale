...
>
  ...
  <div style={{ marginTop: '8px' }}>
    The Brand Header is available in a new{' '}
    <a href="?path=/docs/beta-components-telekom-brand-header-navigation--standard">
      beta version
    </a>
    . Once quality control is complete and WCAG accessibility certification is in
    place, the new component will become the official Telekom brand header.
  </div>
</div>
