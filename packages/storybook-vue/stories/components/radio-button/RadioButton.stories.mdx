...
<Canvas withSource="none">
  <Story
    name="Warning"
    args={{
      label: 'Standard with warning',
      warning: true,
      helperText: 'This is the warning message',
    }}
  >
    {Template.bind({})}
  </Story>
...
<scale-radio-button
  warning
  helper-text="This is the warning message"
></scale-radio-button>
```
...
<Canvas withSource="none">
  <Story
    name="Success"
    args={{
      label: 'Standard with success',
      success: true,
      helperText: 'This is the success message',
    }}
  >
    {Template.bind({})}
  </Story>
...
<scale-radio-button
  success
  helper-text="This is the success message"
></scale-radio-button>
```
