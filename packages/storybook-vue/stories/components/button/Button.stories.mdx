...
export const Template = (args, { argTypes }) => ({
  ...
  template: `
    ...
    >
      ...
      <scale-icon-action-add accessibility-title="Add" v-if="iconOnly" />
...
:host {
  ...
  --transition: all var(--telekom-motion-duration-transition) cubic-bezier(
  ...
  --background-secondary: var(--telekom-color-ui-outlined-fill-standard);
  ...
  --background-ghost-hover: var(--telekom-color-ui-ghost-hovered);
  --background-ghost-active: var(--telekom-color-ui-ghost-pressed);
}
```
...
```html
<scale-button size="small" href="assets/welcome.png" download="welcome.png"
  >Download</scale-button
>
```
