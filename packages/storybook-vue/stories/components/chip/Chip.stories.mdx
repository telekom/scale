...
```html
<scale-chip type="outline">Label</scale-chip>
```
...
```html
<scale-chip disabled type="outline" selected>Label</scale-chip>
```
...
```html
<scale-chip dismissible selected>Label</scale-chip>
```
...
```html
<scale-chip dismissible selected type="outline">Label</scale-chip>
```
