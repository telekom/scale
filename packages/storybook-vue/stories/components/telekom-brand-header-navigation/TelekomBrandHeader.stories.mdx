...
export const TemplateProfile = (args, { argTypes }) => ({
  components: { TelekomHeaderTemplate },
  props: {
    ...TelekomHeaderTemplate.props,
    // TODO remove these from here since they're included already in TelekomHeaderTemplate
...
<Canvas withSource="none">
  <Story
    ...
    height={500}
  >
    {TemplateProfile.bind({})}
  </Story>
</Canvas>

[//]: # (TODO DaSu profile-menu args instead of T-header)
<ArgsTable story="Profile Menu" />
...
<script>
  // TODO DaSu user-info & service-links
</script>
```
