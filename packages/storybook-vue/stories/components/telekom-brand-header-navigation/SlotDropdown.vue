<template>
  <scale-telekom-nav-list slot="main-nav" aria-label="Main Navigation">
    <scale-menu-flyout>
        <scale-telekom-nav-item slot="trigger" aria-label="Topic One">
    ...
    <scale-menu-flyout>
      <scale-telekom-nav-item slot="trigger" aria-label="Topic Two">
