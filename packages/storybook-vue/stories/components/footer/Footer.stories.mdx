...
>
  ...
  <div style={{ marginTop: '8px' }}>
    The Brand Footer is available in a new{' '}
    <a href="?path=/docs/beta-components-telekom-footer--standard">
      beta version
    </a>
    . Once quality control is complete and WCAG accessibility certification is in
    place, the new component will become the official Telekom brand footer.
  </div>
</div>
