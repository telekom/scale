...
```html
<scale-dropdown-select label="Disabled" value="cedric" disabled helper-text="This field is disabled" variant="neutral">
  <scale-dropdown-select-item value="caspar">Caspar</scale-dropdown-select-item>
  <scale-dropdown-select-item value="cedric">Cedric</scale-dropdown-select-item>
  <scale-dropdown-select-item value="cem">Cem</scale-dropdown-select-item>
</scale-dropdown-select>
...
<Canvas withSource="none">
  <Story
    ...
    args={{
      ...
      value: 'cem',
      invalid: true,
      helperText: 'Error: please select a different option',
    }}
  >
    {Template.bind({})}
  </Story>
...
<scale-dropdown-select
  label="Error"
  invalid
  helper-text="Error: please select a different option"
>
  <scale-dropdown-select-item value="caspar">Caspar</scale-dropdown-select-item>
  <scale-dropdown-select-item value="cedric">Cedric</scale-dropdown-select-item>
  <scale-dropdown-select-item value="cem">Cem</scale-dropdown-select-item>
