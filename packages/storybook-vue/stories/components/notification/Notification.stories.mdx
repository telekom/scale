    ...
    {{
      ...
      template: `
        <div>
          ...
          ></scale-slider>
          <p><scale-button variant="secondary" @click="create">Show</scale-button></p>
        </div>
      `,
      methods: {
        create() {
          const toast = Object.assign(
            ...
            {
              heading: `Notification toast #${this.count++}. And a lot more text because we want to test how it behaves.`, 
              type: 'toast',
      ...
      template: `
        <div>
          <scale-notification
            ...
            opened
          >
            <span slot="text">Additional text goes in the 'text' slot.<br /><scale-link to="#">Links can be inlined.</scale-link></span>
          </scale-notification>
        </div>
      `
    }}
...
<scale-notification heading="Notification text goes here" opened>
  <span slot="text">
    Additional text goes in the 'text' slot.
    <br /><scale-link to="#">Links can be inlined.</scale-link>
  </span>
</scale-notification>
```
