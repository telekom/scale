...
To use the Telekom design tokens, import them from the `@telekom/scale-design-tokens` package

- `@telekom/scale-design-tokens/dist/design-tokens-telekom.css` for **CSS**
- `@telekom/scale-design-tokens/dist/design-tokens-telekom.js` for **JavaScript** (or CSS-in-JS)
